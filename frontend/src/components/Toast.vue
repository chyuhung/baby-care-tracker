<template>
  <div class="fixed top-[max(env(safe-area-inset-top),1rem)] left-1/2 -translate-x-1/2 z-[100] w-[90%] max-w-[380px] space-y-2 pointer-events-none" role="status" aria-live="polite">
